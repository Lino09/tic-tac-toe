const Footer = ():JSX.Element => (
  ...
  <div className="mx-auto max-w-screen-xl text-center">
      ...
      <p className="my-6 text-gray-500 dark:text-gray-400">Free website to play with your friends. Because I needed to practice websockets</p>
      ...
      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 <a href="#" className="hover:underline">Flattworld™</a>. All Rights Reserved.</span>
  </div>
</footer>
)
